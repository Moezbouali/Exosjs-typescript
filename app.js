...
var userService_1 = require("./userService"); // Assurez-vous que le chemin est correct
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, userService_1.getUsers)()];
                case 1:
                    users = _a.sent();
                ...
                case 2:
                    ...
                    console.error("An error occurred while fetching users:", error_1);
                    return [3 /*break*/, 3];
